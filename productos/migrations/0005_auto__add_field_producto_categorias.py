...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('productos_producto', 'categorias', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Producto.categorias'
        db.delete_column('productos_producto', 'categorias')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 21, 46, 56, 989865)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 23, 21, 46, 56, 989775)'}),
