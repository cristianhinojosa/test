...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('productos_producto', (
            ...
            ('fecha_inicio', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 5, 26, 0, 0))),
            ('fecha_termino', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 8, 24, 0, 0))),
    ...
    models = {
        ...
        'productos.producto': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 26, 0, 0)'}),
            'fecha_termino': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 8, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
